...
class HXCPP_CLASS_ATTRIBUTES Ratings_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String CalculateRating(Float noteDiff, ::Dynamic burning, ::Dynamic customSafeZone);
		static ::Dynamic CalculateRating_dyn();

		static ::String checkRating(Float ms,Float ts,int burning);
		static ::Dynamic checkRating_dyn();

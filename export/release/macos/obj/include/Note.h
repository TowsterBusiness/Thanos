...
class HXCPP_CLASS_ATTRIBUTES Note_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float strumTime,int noteData, ::Dynamic burning, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_inCharter);
		...
		static ::hx::ObjectPtr< Note_obj > __new(Float strumTime,int noteData, ::Dynamic burning, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_inCharter);
		static ::hx::ObjectPtr< Note_obj > __alloc(::hx::Ctx *_hx_ctx,Float strumTime,int noteData, ::Dynamic burning, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_inCharter);

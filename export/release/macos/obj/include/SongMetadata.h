...
HX_DECLARE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_343_new)
...
{
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_343_new)
HXLINE( 347)		( ( ::SongMetadata)(__this) )->songCharacter = HX_("",00,00,00,00);
HXLINE( 346)		( ( ::SongMetadata)(__this) )->week = 0;
HXLINE( 345)		( ( ::SongMetadata)(__this) )->songName = HX_("",00,00,00,00);
HXLINE( 351)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 352)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 353)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
            	}

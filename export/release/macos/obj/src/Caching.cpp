...
HXLINE(  31)		 ::Caching _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE(  43)		{
HXLINE(  43)			 ::flixel::FlxSprite _g = this->kadeLogo;
HXDLIN(  43)			Float _g1 = _g->x;
HXDLIN(  43)			_g->set_x((_g1 - (this->kadeLogo->get_width() / ( (Float)(2) ))));
            		}
HXLINE(  44)		{
HXLINE(  44)			 ::flixel::FlxSprite _g2 = this->kadeLogo;
HXDLIN(  44)			Float _g3 = _g2->y;
HXDLIN(  44)			_g2->set_y((_g3 - ((this->kadeLogo->get_height() / ( (Float)(2) )) + 100)));
            		}
HXLINE(  45)		{
HXLINE(  45)			 ::flixel::text::FlxText _g4 = this->text;
HXDLIN(  45)			Float _g5 = _g4->y;
HXDLIN(  45)			_g4->set_y((_g5 - ((this->kadeLogo->get_height() / ( (Float)(2) )) - ( (Float)(125) ))));
            		}
HXLINE(  46)		{
HXLINE(  46)			 ::flixel::text::FlxText _g6 = this->text;
HXDLIN(  46)			_g6->set_x((_g6->x - ( (Float)(170) )));
            		}
...
HXLINE(  56)		 ::Dynamic this1 =  ::__hxcpp_thread_create( ::Dynamic(new _hx_Closure_0(_gthis)));

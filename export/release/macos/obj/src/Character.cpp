...
HXLINE( 391)			{
HXLINE( 391)				 ::Character _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 391)				_g->set_width((_g->get_width() - ( (Float)(100) )));
            			}
HXLINE( 392)			{
HXLINE( 392)				 ::Character _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 392)				_g1->set_height((_g1->get_height() - ( (Float)(100) )));
            			}

...
HX_DEFINE_STACK_FRAME(_hx_pos_94908c72a49529df_531_new,"NPSDisplayOption","new",0x0195d6b8,"NPSDisplayOption.new","Options.hx",531,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_537_press,"NPSDisplayOption","press",0x231a9fdb,"NPSDisplayOption.press","Options.hx",537,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_545_updateDisplay,"NPSDisplayOption","updateDisplay",0xf172f391,"NPSDisplayOption.updateDisplay","Options.hx",545,0x9d9a0240)

void NPSDisplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_531_new)
HXLINE( 532)		super::__construct();
HXLINE( 533)		this->description = desc;
            	}
...
bool NPSDisplayOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_537_press)
HXLINE( 538)		::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 539)		this->display = this->updateDisplay();
HXLINE( 540)		return true;
            	}


::String NPSDisplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_545_updateDisplay)
HXDLIN( 545)		::String _hx_tmp;
HXDLIN( 545)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) ))) {
HXDLIN( 545)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 545)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 545)		return (HX_("NPS Display ",ed,73,73,03) + _hx_tmp);
            	}

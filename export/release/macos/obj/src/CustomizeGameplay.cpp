...
HX_DEFINE_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_594_new,"CustomizeGameplay","new",0xb144179b,"CustomizeGameplay.new","Options.hx",594,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_600_press,"CustomizeGameplay","press",0xcb851f7e,"CustomizeGameplay.press","Options.hx",600,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_608_updateDisplay,"CustomizeGameplay","updateDisplay",0x26aa4e34,"CustomizeGameplay.updateDisplay","Options.hx",608,0x9d9a0240)

void CustomizeGameplay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_594_new)
HXLINE( 595)		super::__construct();
HXLINE( 596)		this->description = desc;
            	}
...
bool CustomizeGameplay_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_600_press)
HXLINE( 601)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),601,HX_("CustomizeGameplay",29,ae,ab,0c),HX_("press",83,53,88,c8)));
HXLINE( 602)		{
HXLINE( 602)			 ::flixel::FlxState nextState =  ::GameplayCustomizeState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 602)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 602)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String CustomizeGameplay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_608_updateDisplay)
HXDLIN( 608)		return HX_("Customize Gameplay",a3,2e,c4,04);
            	}

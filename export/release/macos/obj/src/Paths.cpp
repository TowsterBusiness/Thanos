...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_42_getLibraryPath,"Paths","getLibraryPath",0xe56efeaa,"Paths.getLibraryPath","Paths.hx",42,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_47_getLibraryPathForce,"Paths","getLibraryPathForce",0xe1e5bae1,"Paths.getLibraryPathForce","Paths.hx",47,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_52_getPreloadPath,"Paths","getPreloadPath",0x2fdd9e78,"Paths.getPreloadPath","Paths.hx",52,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_57_file,"Paths","file",0x8f872fdc,"Paths.file","Paths.hx",57,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_62_lua,"Paths","lua",0x5a344458,"Paths.lua","Paths.hx",62,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_67_luaImage,"Paths","luaImage",0xedd38be3,"Paths.luaImage","Paths.hx",67,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_72_txt,"Paths","txt",0x5a3a5910,"Paths.txt","Paths.hx",72,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_77_xml,"Paths","xml",0x5a3d5877,"Paths.xml","Paths.hx",77,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_82_json,"Paths","json",0x9233a388,"Paths.json","Paths.hx",82,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_87_sound,"Paths","sound",0x86f65f6f,"Paths.sound","Paths.hx",87,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_92_soundRandom,"Paths","soundRandom",0x8e79b2d2,"Paths.soundRandom","Paths.hx",92,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_97_music,"Paths","music",0x1684a345,"Paths.music","Paths.hx",97,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_101_voices,"Paths","voices",0xbbb84fe1,"Paths.voices","Paths.hx",101,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_111_inst,"Paths","inst",0x9186a526,"Paths.inst","Paths.hx",111,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_122_image,"Paths","image",0xc392f1fb,"Paths.image","Paths.hx",122,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_127_font,"Paths","font",0x8f8bbf2f,"Paths.font","Paths.hx",127,0x309ea470)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_137_getPackerAtlas,"Paths","getPackerAtlas",0xa8de8c4f,"Paths.getPackerAtlas","Paths.hx",137,0x309ea470)
...
HXLINE(  37)		return (HX_("assets/",4c,2a,dc,36) + file);
            	}
...
::String Paths_obj::getLibraryPath(::String file,::String __o_library){
            	...
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_42_getLibraryPath)
HXDLIN(  42)		bool _hx_tmp;
HXDLIN(  42)		if ((library != HX_("preload",c9,47,43,35))) {
HXDLIN(  42)			_hx_tmp = (library == HX_("default",c1,d8,c3,9b));
            		}
            		else {
HXDLIN(  42)			_hx_tmp = true;
            		}
HXDLIN(  42)		if (_hx_tmp) {
HXDLIN(  42)			return (HX_("assets/",4c,2a,dc,36) + file);
            		}
            		else {
...
::String Paths_obj::getLibraryPathForce(::String file,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_47_getLibraryPathForce)
HXDLIN(  47)		return (((((HX_("",00,00,00,00) + library) + HX_(":assets/",52,05,4a,2c)) + library) + HX_("/",2f,00,00,00)) + file);
            	}
...
::String Paths_obj::getPreloadPath(::String file){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_52_getPreloadPath)
HXDLIN(  52)		return (HX_("assets/",4c,2a,dc,36) + file);
            	}
...
::String Paths_obj::file(::String file,::String __o_type,::String library){
            	...
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_57_file)
HXDLIN(  57)		return ::Paths_obj::getPath(file,type,library);
            	}
...
::String Paths_obj::lua(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_62_lua)
HXDLIN(  62)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".lua",4a,2a,ba,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::luaImage(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_67_luaImage)
HXDLIN(  67)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            	}
...
::String Paths_obj::txt(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_72_txt)
HXDLIN(  72)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::xml(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_77_xml)
HXDLIN(  77)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::json(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_82_json)
HXDLIN(  82)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::sound(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_87_sound)
HXDLIN(  87)		return ::Paths_obj::getPath((((HX_("sounds/",eb,02,a5,b6) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("SOUND",af,c4,ba,fe),library);
            	}
...
::String Paths_obj::soundRandom(::String key,int min,int max,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_92_soundRandom)
HXDLIN(  92)		return ::Paths_obj::sound((key + ::flixel::FlxG_obj::random->_hx_int(min,max,null())),library);
            	}
...
::String Paths_obj::music(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_97_music)
HXDLIN(  97)		return ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            	}
...
::String Paths_obj::voices(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_101_voices)
HXLINE( 102)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 103)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 104)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 104)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 105)			songLowercase = HX_("philly",28,77,5e,ef);
...
::String Paths_obj::inst(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_111_inst)
HXLINE( 112)		::String songLowercase = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXLINE( 113)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 114)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 114)			goto _hx_goto_16;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 115)			songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 115)			goto _hx_goto_16;
            		}
            		_hx_goto_16:;
HXLINE( 117)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
::String Paths_obj::image(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_122_image)
HXDLIN( 122)		return ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            	}
...
::String Paths_obj::font(::String key){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_127_font)
HXDLIN( 127)		return (HX_("assets/fonts/",37,ff,a5,9c) + key);
            	}
...
HXDLIN( 132)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,getSparrowAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getPackerAtlas(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_137_getPackerAtlas)
HXDLIN( 137)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 137)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}

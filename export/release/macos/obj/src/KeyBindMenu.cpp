...
HXLINE( 260)				{
HXLINE( 260)					 ::flixel::text::FlxText _g = this->keyTextDisplay;
HXDLIN( 260)					_g->set_text((_g->text + ((((textStart + this->keyText->__get(0)) + HX_(": ",a6,32,00,00)) + this->gpKeys->__get(0)) + HX_("\n",0a,00,00,00))));
            				}
            			}
HXLINE( 256)			{
...
HXLINE( 260)				{
HXLINE( 260)					 ::flixel::text::FlxText _g1 = this->keyTextDisplay;
HXDLIN( 260)					_g1->set_text((_g1->text + ((((textStart1 + this->keyText->__get(1)) + HX_(": ",a6,32,00,00)) + this->gpKeys->__get(1)) + HX_("\n",0a,00,00,00))));
            				}
            			}
HXLINE( 256)			{
...
HXLINE( 260)				{
HXLINE( 260)					 ::flixel::text::FlxText _g2 = this->keyTextDisplay;
HXDLIN( 260)					_g2->set_text((_g2->text + ((((textStart2 + this->keyText->__get(2)) + HX_(": ",a6,32,00,00)) + this->gpKeys->__get(2)) + HX_("\n",0a,00,00,00))));
            				}
            			}
HXLINE( 256)			{
...
HXLINE( 260)				{
HXLINE( 260)					 ::flixel::text::FlxText _g3 = this->keyTextDisplay;
HXDLIN( 260)					_g3->set_text((_g3->text + ((((textStart3 + this->keyText->__get(3)) + HX_(": ",a6,32,00,00)) + this->gpKeys->__get(3)) + HX_("\n",0a,00,00,00))));
            				}
            			}
            		}
            		else {
...
HXLINE( 269)				{
HXLINE( 269)					 ::flixel::text::FlxText _g = this->keyTextDisplay;
...
HXDLIN( 269)					_g->set_text((_g->text + (((((textStart + this->keyText->__get(0)) + HX_(": ",a6,32,00,00)) + _hx_tmp) + this->keyText->__get(0)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
HXLINE( 266)			{
...
HXLINE( 269)				{
HXLINE( 269)					 ::flixel::text::FlxText _g1 = this->keyTextDisplay;
...
HXDLIN( 269)					_g1->set_text((_g1->text + (((((textStart1 + this->keyText->__get(1)) + HX_(": ",a6,32,00,00)) + _hx_tmp1) + this->keyText->__get(1)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
HXLINE( 266)			{
...
HXLINE( 269)				{
HXLINE( 269)					 ::flixel::text::FlxText _g2 = this->keyTextDisplay;
...
HXDLIN( 269)					_g2->set_text((_g2->text + (((((textStart2 + this->keyText->__get(2)) + HX_(": ",a6,32,00,00)) + _hx_tmp2) + this->keyText->__get(2)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
HXLINE( 266)			{
...
HXLINE( 269)				{
HXLINE( 269)					 ::flixel::text::FlxText _g3 = this->keyTextDisplay;
...
HXDLIN( 269)					_g3->set_text((_g3->text + (((((textStart3 + this->keyText->__get(3)) + HX_(": ",a6,32,00,00)) + _hx_tmp3) + this->keyText->__get(3)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
            		}

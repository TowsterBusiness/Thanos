...
HXLINE( 644)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),644,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
...
HXLINE( 652)		::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),652,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE( 653)		{

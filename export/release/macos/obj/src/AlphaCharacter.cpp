...
HX_DEFINE_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_266_new,"AlphaCharacter","new",0xcdf30efd,"AlphaCharacter.new","Alphabet.hx",266,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_286_createBold,"AlphaCharacter","createBold",0x537dc1a4,"AlphaCharacter.createBold","Alphabet.hx",286,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_293_createLetter,"AlphaCharacter","createLetter",0xc29272c5,"AlphaCharacter.createLetter","Alphabet.hx",293,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_311_createNumber,"AlphaCharacter","createNumber",0xc1044ca8,"AlphaCharacter.createNumber","Alphabet.hx",311,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_319_createSymbol,"AlphaCharacter","createSymbol",0x0e677537,"AlphaCharacter.createSymbol","Alphabet.hx",319,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_268_boot,"AlphaCharacter","boot",0x5ed30ef5,"AlphaCharacter.boot","Alphabet.hx",268,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_270_boot,"AlphaCharacter","boot",0x5ed30ef5,"AlphaCharacter.boot","Alphabet.hx",270,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_272_boot,"AlphaCharacter","boot",0x5ed30ef5,"AlphaCharacter.boot","Alphabet.hx",272,0xc2e40fcb)

void AlphaCharacter_obj::__construct(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_266_new)
HXLINE( 274)		this->row = 0;
HXLINE( 278)		super::__construct(x,y,null());
HXLINE( 279)		::String library = null();
HXDLIN( 279)		::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("alphabet",b3,7c,38,21)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 279)		 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("alphabet",b3,7c,38,21)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 280)		this->set_frames(tex1);
HXLINE( 282)		this->set_antialiasing(true);
            	}
...
void AlphaCharacter_obj::createBold(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_286_createBold)
HXLINE( 287)		 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN( 287)		_hx_tmp->addByPrefix(letter,(letter.toUpperCase() + HX_(" bold",a5,11,ee,ad)),24,null(),null(),null());
HXLINE( 288)		this->animation->play(letter,null(),null(),null());
...
void AlphaCharacter_obj::createLetter(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_293_createLetter)
HXLINE( 294)		::String letterCase = HX_("lowercase",31,ad,a5,66);
HXLINE( 295)		if ((letter.toLowerCase() != letter)) {
HXLINE( 297)			letterCase = HX_("capital",a8,a6,0b,a0);
            		}
HXLINE( 300)		this->animation->addByPrefix(letter,((letter + HX_(" ",20,00,00,00)) + letterCase),24,null(),null(),null());
HXLINE( 301)		this->animation->play(letter,null(),null(),null());
HXLINE( 302)		this->updateHitbox();
HXLINE( 306)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 307)		{
HXLINE( 307)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 307)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
void AlphaCharacter_obj::createNumber(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_311_createNumber)
HXLINE( 312)		this->animation->addByPrefix(letter,letter,24,null(),null(),null());
...
void AlphaCharacter_obj::createSymbol(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_319_createSymbol)
HXLINE( 320)		::String _hx_switch_0 = letter;
            		if (  (_hx_switch_0==HX_(" ",20,00,00,00)) ){
HXLINE( 376)			this->animation->addByPrefix(letter,HX_("space",c6,8c,66,81),24,null(),null(),null());
HXLINE( 377)			this->animation->play(letter,null(),null(),null());
HXLINE( 375)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 334)			this->animation->addByPrefix(letter,HX_("exclamation point",dd,17,c1,eb),24,null(),null(),null());
HXLINE( 335)			this->animation->play(letter,null(),null(),null());
HXLINE( 333)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("\"",22,00,00,00)) ){
HXLINE( 365)			this->animation->addByPrefix(letter,HX_("\"",22,00,00,00),24,null(),null(),null());
HXLINE( 366)			this->animation->play(letter,null(),null(),null());
HXLINE( 367)			{
HXLINE( 367)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 367)				_g->set_y(_g->y);
            			}
HXLINE( 364)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("#",23,00,00,00)) ){
HXLINE( 341)			this->animation->addByPrefix(letter,HX_("#",23,00,00,00),24,null(),null(),null());
HXLINE( 342)			this->animation->play(letter,null(),null(),null());
HXLINE( 340)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("$",24,00,00,00)) ){
HXLINE( 344)			this->animation->addByPrefix(letter,HX_("$",24,00,00,00),24,null(),null(),null());
HXLINE( 345)			this->animation->play(letter,null(),null(),null());
HXLINE( 343)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("%",25,00,00,00)) ){
HXLINE( 347)			this->animation->addByPrefix(letter,HX_("%",25,00,00,00),24,null(),null(),null());
HXLINE( 348)			this->animation->play(letter,null(),null(),null());
HXLINE( 346)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("&",26,00,00,00)) ){
HXLINE( 350)			this->animation->addByPrefix(letter,HX_("&",26,00,00,00),24,null(),null(),null());
HXLINE( 351)			this->animation->play(letter,null(),null(),null());
HXLINE( 349)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("'",27,00,00,00)) ){
HXLINE( 327)			this->animation->addByPrefix(letter,HX_("apostraphie",04,43,cf,ad),24,null(),null(),null());
HXLINE( 328)			this->animation->play(letter,null(),null(),null());
HXLINE( 329)			{
HXLINE( 329)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 329)				_g->set_y(_g->y);
            			}
HXLINE( 326)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("(",28,00,00,00)) ){
HXLINE( 353)			this->animation->addByPrefix(letter,HX_("(",28,00,00,00),24,null(),null(),null());
HXLINE( 354)			this->animation->play(letter,null(),null(),null());
HXLINE( 352)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_(")",29,00,00,00)) ){
HXLINE( 356)			this->animation->addByPrefix(letter,HX_(")",29,00,00,00),24,null(),null(),null());
HXLINE( 357)			this->animation->play(letter,null(),null(),null());
HXLINE( 355)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("+",2b,00,00,00)) ){
HXLINE( 359)			this->animation->addByPrefix(letter,HX_("+",2b,00,00,00),24,null(),null(),null());
HXLINE( 360)			this->animation->play(letter,null(),null(),null());
HXLINE( 358)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 362)			this->animation->addByPrefix(letter,HX_("-",2d,00,00,00),24,null(),null(),null());
HXLINE( 363)			this->animation->play(letter,null(),null(),null());
HXLINE( 361)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ){
HXLINE( 323)			this->animation->addByPrefix(letter,HX_("period",01,61,1b,3b),24,null(),null(),null());
HXLINE( 324)			this->animation->play(letter,null(),null(),null());
HXLINE( 325)			{
HXLINE( 325)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 325)				_g->set_y((_g->y + 50));
            			}
HXLINE( 322)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("?",3f,00,00,00)) ){
HXLINE( 331)			this->animation->addByPrefix(letter,HX_("question mark",47,0b,f6,d2),24,null(),null(),null());
HXLINE( 332)			this->animation->play(letter,null(),null(),null());
HXLINE( 330)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("@",40,00,00,00)) ){
HXLINE( 369)			this->animation->addByPrefix(letter,HX_("@",40,00,00,00),24,null(),null(),null());
HXLINE( 370)			this->animation->play(letter,null(),null(),null());
HXLINE( 368)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("^",5e,00,00,00)) ){
HXLINE( 372)			this->animation->addByPrefix(letter,HX_("^",5e,00,00,00),24,null(),null(),null());
HXLINE( 373)			this->animation->play(letter,null(),null(),null());
HXLINE( 374)			{
HXLINE( 374)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 374)				_g->set_y(_g->y);
            			}
HXLINE( 371)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("_",5f,00,00,00)) ){
HXLINE( 337)			this->animation->addByPrefix(letter,HX_("_",5f,00,00,00),24,null(),null(),null());
HXLINE( 338)			this->animation->play(letter,null(),null(),null());
HXLINE( 339)			{
HXLINE( 339)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 339)				_g->set_y((_g->y + 50));
            			}
HXLINE( 336)			goto _hx_goto_4;
            		}
            		_hx_goto_4:;
...
{
{
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_268_boot)
HXDLIN( 268)		alphabet = HX_("abcdefghijklmnopqrstuvwxyz",6d,97,f1,fb);
            	}
{
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_270_boot)
HXDLIN( 270)		numbers = HX_("1234567890",5b,2e,e3,45);
            	}
{
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_272_boot)
HXDLIN( 272)		symbols = HX_("|~#$%()*+-:;<=>@[]^_.,'!? ",49,1e,7a,47);
            	}
}

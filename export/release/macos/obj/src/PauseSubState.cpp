...
HXDLIN( 136)		if (!(::PlayerSettings_obj::player1->controls->_upP->check())) {
HXLINE( 136)			_hx_tmp1 = upPcontroller;
            		}
            		else {
...
HXDLIN( 141)			if (!(::PlayerSettings_obj::player1->controls->_downP->check())) {
HXLINE( 141)				_hx_tmp = downPcontroller;
            			}
            			else {
...
HXDLIN( 147)				if (!(::PlayerSettings_obj::player1->controls->_leftP->check())) {
HXLINE( 147)					_hx_tmp = leftPcontroller;
            				}
            				else {
...
HXDLIN( 175)					if (!(::PlayerSettings_obj::player1->controls->_rightP->check())) {
HXLINE( 175)						_hx_tmp = rightPcontroller;
            					}
            					else {
...
HXLINE( 180)						this->perSongOffset->set_text((((HX_("Additive Offset (Left, Right): ",5d,60,ef,2e) + ::PlayState_obj::songOffset) + HX_(" - Description - ",ca,32,1d,cd)) + HX_("Adds value to global offset, per song.",5a,ef,29,77)));
HXLINE( 181)						if (!(this->offsetChanged)) {
HXLINE( 183)							this->grpMenuShit->clear();
HXLINE( 185)							this->menuItems = ::Array_obj< ::String >::fromData( _hx_array_data_08e59567_9,2);
HXLINE( 187)							{
HXLINE( 187)								int _g = 0;
HXDLIN( 187)								int _g1 = this->menuItems->length;
HXDLIN( 187)								while((_g < _g1)){
HXLINE( 187)									_g = (_g + 1);
HXDLIN( 187)									int i = (_g - 1);
HXLINE( 189)									 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null());
HXLINE( 190)									songText->isMenuItem = true;
HXLINE( 191)									songText->targetY = ( (Float)(i) );
HXLINE( 192)									this->grpMenuShit->add(songText).StaticCast<  ::Alphabet >();
            								}
            							}
HXLINE( 195)							this->changeSelection(null());
HXLINE( 197)							this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
HXLINE( 198)							this->offsetChanged = true;
            						}
            					}
            				}
            			}
            		}
HXLINE( 203)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 205)			::String daSelected = this->menuItems->__get(this->curSelected);
HXLINE( 207)			::String _hx_switch_1 = daSelected;
            			if (  (_hx_switch_1==HX_("Exit to menu",82,87,9a,a9)) ){
HXLINE( 220)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 222)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 223)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 224)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 226)				if (::PlayState_obj::loadRep) {
HXLINE( 228)					::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),false,::hx::paccDynamic);
HXLINE( 229)					::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeed",3a,e0,46,cb),1,::hx::paccDynamic);
HXLINE( 230)					::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),false,::hx::paccDynamic);
            				}
HXLINE( 232)				::PlayState_obj::loadRep = false;
HXLINE( 240)				if (::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),290 )) {
HXLINE( 241)					::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->setFPSCap(( (Float)(290) ));
            				}
HXLINE( 243)				{
HXLINE( 243)					 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 212)				if (::PlayState_obj::instance->useVideo) {
HXLINE( 214)					::GlobalVideo_obj::get()->__Field(HX_("stop",02,f0,5b,4c),::hx::paccDynamic)();
HXLINE( 215)					::PlayState_obj::instance->remove(::PlayState_obj::instance->videoSprite,null()).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 216)					::PlayState_obj::instance->removedVideo = true;
            				}
HXLINE( 218)				{
HXLINE( 218)					 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
...
HXDLIN( 247)		bool _hx_tmp2 = _this->keyManager->checkStatus(74,_this->status);
            	}
...
HXLINE( 266)			this->curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 267)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 268)			this->curSelected = 0;
            		}
HXLINE( 270)		int bullShit = 0;
HXLINE( 272)		{
HXLINE( 272)			int _g = 0;
HXDLIN( 272)			::Array< ::Dynamic> _g1 = this->grpMenuShit->members;
HXDLIN( 272)			while((_g < _g1->length)){
HXLINE( 272)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 272)				_g = (_g + 1);
HXLINE( 274)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 275)				bullShit = (bullShit + 1);
HXLINE( 277)				item->set_alpha(((Float)0.6));
HXLINE( 280)				if ((item->targetY == 0)) {
HXLINE( 282)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}

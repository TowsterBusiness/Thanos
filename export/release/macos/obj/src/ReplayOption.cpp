...
HX_DEFINE_STACK_FRAME(_hx_pos_1637001de69262c2_552_new,"ReplayOption","new",0x7094b10e,"ReplayOption.new","Options.hx",552,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_558_press,"ReplayOption","press",0x73453bb1,"ReplayOption.press","Options.hx",558,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_566_updateDisplay,"ReplayOption","updateDisplay",0xfbfe5567,"ReplayOption.updateDisplay","Options.hx",566,0x9d9a0240)

void ReplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_552_new)
HXLINE( 553)		super::__construct();
HXLINE( 554)		this->description = desc;
            	}
...
bool ReplayOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_1637001de69262c2_558_press)
HXLINE( 559)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),559,HX_("ReplayOption",1c,d2,4f,b9),HX_("press",83,53,88,c8)));
HXLINE( 560)		{
HXLINE( 560)			 ::flixel::FlxState nextState =  ::LoadReplayState_obj::__alloc( HX_CTX ,null(),null());
...
::String ReplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_566_updateDisplay)
HXDLIN( 566)		return HX_("Load replays",92,1b,40,79);
            	}

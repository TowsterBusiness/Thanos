...
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_183_changeSelection,"LoadReplayState","changeSelection",0x45620112,"LoadReplayState.changeSelection","LoadReplayState.hx",183,0xb45e587a)
...
HXLINE( 180)		this->isSettingControl = false;
...
HXDLIN(  57)				_hx_tmp[i] = (_hx_tmp1 + ::CoolUtil_obj::difficultyFromInt(( (int)(rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) )).toUpperCase());
            			}
            		}
...
HXLINE( 105)				if ((pog->songName == songName)) {
...
HXLINE( 151)			if (::hx::IsEq( ::PlayState_obj::rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 155)				::String songFormat = ::StringTools_obj::replace(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 156)				::String _hx_switch_0 = songFormat;
            				if (  (_hx_switch_0==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 157)					songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 157)					goto _hx_goto_22;
            				}
            				if (  (_hx_switch_0==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 158)					songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 158)					goto _hx_goto_22;
            				}
            				if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 160)					songFormat = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 160)					goto _hx_goto_22;
            				}
            				if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 161)					songFormat = HX_("Philly",48,eb,f2,23);
HXDLIN( 161)					goto _hx_goto_22;
            				}
            				_hx_goto_22:;
HXLINE( 164)				::String poop = ::Highscore_obj::formatSong(songFormat,( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) ));
HXLINE( 166)				::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop,( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ));
HXLINE( 167)				::PlayState_obj::isStoryMode = false;
HXLINE( 168)				::PlayState_obj::storyDifficulty = ( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) );
HXLINE( 169)				::PlayState_obj::storyWeek = this->getWeekNumbFromSong(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ));
HXLINE( 170)				{
HXLINE( 170)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN( 170)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 170)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            			}
            			else {
HXLINE( 174)				::PlayState_obj::rep = null();
HXLINE( 175)				::PlayState_obj::loadRep = false;
            			}
            		}
            	}
...
void LoadReplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_183_changeSelection)
...
HXLINE( 190)		 ::LoadReplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 190)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 192)		if ((this->curSelected < 0)) {
HXLINE( 193)			this->curSelected = (this->grpControls->length - 1);
            		}
HXLINE( 194)		if ((this->curSelected >= this->grpControls->length)) {
HXLINE( 195)			this->curSelected = 0;
            		}
HXLINE( 197)		 ::Replay rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 199)		 ::flixel::text::FlxText _hx_tmp2 = this->poggerDetails;
HXDLIN( 199)		::String _hx_tmp3 = ((HX_("Replay Details - \nDate Created: ",9c,0e,70,a7) + ::Std_obj::string( ::Dynamic(rep->replay->__Field(HX_("timestamp",d6,d4,ce,a5),::hx::paccDynamic)))) + HX_("\nSong: ",65,cd,f3,01));
HXDLIN( 199)		::String _hx_tmp4;
HXDLIN( 199)		if (::hx::IsNotEq( rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 199)			_hx_tmp4 = HX_("OUTDATED not useable!",45,90,99,ff);
            		}
            		else {
HXLINE( 199)			_hx_tmp4 = HX_("Latest",67,79,f7,89);
            		}
HXDLIN( 199)		_hx_tmp2->set_text(( (::String)(((((((_hx_tmp3 + rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) + HX_("\nReplay Version: ",8f,f9,99,d3)) + rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic)) + HX_(" (",08,1c,00,00)) + _hx_tmp4) + HX_(")\n",c1,23,00,00))) ));
HXLINE( 203)		int bullShit = 0;
HXLINE( 205)		{
HXLINE( 205)			int _g = 0;
HXDLIN( 205)			::Array< ::Dynamic> _g1 = this->grpControls->members;
HXDLIN( 205)			while((_g < _g1->length)){
HXLINE( 205)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 205)				_g = (_g + 1);
HXLINE( 207)				item->targetY = ( (Float)((bullShit - this->curSelected)) );

...
HX_DEFINE_STACK_FRAME(_hx_pos_da44038d8b33767f_343_new,"FPSOption","new",0xd6c03010,"FPSOption.new","Options.hx",343,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_349_press,"FPSOption","press",0x5a8fff33,"FPSOption.press","Options.hx",349,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_358_updateDisplay,"FPSOption","updateDisplay",0x3edb6ae9,"FPSOption.updateDisplay","Options.hx",358,0x9d9a0240)

void FPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_343_new)
HXLINE( 344)		super::__construct();
HXLINE( 345)		this->description = desc;
            	}
...
bool FPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_349_press)
HXLINE( 350)		::flixel::FlxG_obj::save->data->__SetField(HX_("fps",e9,c7,4d,00),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 351)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
HXLINE( 352)		this->display = this->updateDisplay();
HXLINE( 353)		return true;
            	}


::String FPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_358_updateDisplay)
HXDLIN( 358)		::String _hx_tmp;
HXDLIN( 358)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ))) {
HXDLIN( 358)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 358)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 358)		return (HX_("FPS Counter ",fb,a4,fc,60) + _hx_tmp);
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_7861c1e414cf422e_488_new,"RainbowFPSOption","new",0xb4ce913a,"RainbowFPSOption.new","Options.hx",488,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_494_press,"RainbowFPSOption","press",0xa1d87edd,"RainbowFPSOption.press","Options.hx",494,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_503_updateDisplay,"RainbowFPSOption","updateDisplay",0xe58aa493,"RainbowFPSOption.updateDisplay","Options.hx",503,0x9d9a0240)

void RainbowFPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_488_new)
...
bool RainbowFPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_494_press)
HXLINE( 495)		::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 496)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->changeFPSColor(-1);
HXLINE( 497)		this->display = this->updateDisplay();
HXLINE( 498)		return true;
            	}


::String RainbowFPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_503_updateDisplay)
HXDLIN( 503)		::String _hx_tmp;
HXDLIN( 503)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) ))) {
HXDLIN( 503)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 503)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 503)		return (HX_("FPS Rainbow ",81,45,9e,9c) + _hx_tmp);
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_343_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",343,0x0d86f62d)
...
HXLINE( 347)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 346)		this->week = 0;
HXLINE( 345)		this->songName = HX_("",00,00,00,00);
HXLINE( 351)		this->songName = song;
HXLINE( 352)		this->week = week;
HXLINE( 353)		this->songCharacter = songCharacter;
            	}

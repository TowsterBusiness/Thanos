...
void Controls_obj::copyFrom( ::Controls controls, ::Device device){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_384_copyFrom)
HXLINE( 386)		{
HXLINE( 386)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,controls->byName);
HXDLIN( 386)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 386)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 386)				::String name = ( (::String)(_g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN( 386)				 ::flixel::input::actions::FlxActionDigital action = ( ( ::flixel::input::actions::FlxActionDigital)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 388)				{
HXLINE( 388)					int _g2 = 0;
HXDLIN( 388)					::Array< ::Dynamic> _g3 = action->inputs;
HXDLIN( 388)					while((_g2 < _g3->length)){
HXLINE( 388)						 ::flixel::input::actions::FlxActionInput input = _g3->__get(_g2).StaticCast<  ::flixel::input::actions::FlxActionInput >();
...
HXDLIN( 436)		if (::hx::IsNotEq( scheme,::KeyboardScheme_obj::None_dyn() )) {
...
HXLINE( 609)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_616_addGamepad)
...
HXDLIN( 623)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_632_addGamepadLiteral)
...
HXDLIN( 636)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
...
HXDLIN( 663)				 ::Control control = _g->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
...
HXDLIN( 486)			if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {

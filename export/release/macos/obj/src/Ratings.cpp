...
HX_LOCAL_STACK_FRAME(_hx_pos_c466427e4f3e0023_141_checkRating,"Ratings","checkRating",0xba9f502d,"Ratings.checkRating","Ratings.hx",141,0x142ad6e8)
HX_LOCAL_STACK_FRAME(_hx_pos_c466427e4f3e0023_176_CalculateRanking,"Ratings","CalculateRanking",0xb7ac9fe8,"Ratings.CalculateRanking","Ratings.hx",176,0x142ad6e8)
...
::String Ratings_obj::CalculateRating(Float noteDiff, ::Dynamic burning, ::Dynamic customSafeZone){
...
HXDLIN( 123)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )) {
HXLINE( 123)			_hx_tmp = !(::PlayState_obj::loadRep);
            		}
            		else {
HXLINE( 123)			_hx_tmp = false;
            		}
HXDLIN( 123)		if (_hx_tmp) {
HXLINE( 124)			return HX_("sick",be,8c,53,4c);
            		}
HXLINE( 126)		::String rating;
HXLINE( 128)		if (::hx::IsNotNull( burning )) {
HXLINE( 129)			rating = ::Ratings_obj::checkRating(noteDiff,customTimeScale,( (int)(burning) ));
            		}
            		else {
HXLINE( 133)			rating = ::Ratings_obj::checkRating(noteDiff,customTimeScale,0);
            		}
HXLINE( 137)		return rating;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(Ratings_obj,CalculateRating,return )

::String Ratings_obj::checkRating(Float ms,Float ts,int burning){
            	HX_STACKFRAME(&_hx_pos_c466427e4f3e0023_141_checkRating)
HXLINE( 142)		::String rating = HX_("sick",be,8c,53,4c);
HXLINE( 144)		bool _hx_tmp;
HXDLIN( 144)		bool _hx_tmp1;
HXDLIN( 144)		if ((burning == 1)) {
HXLINE( 144)			_hx_tmp1 = (ms < (( (Float)(50) ) * ts));
            		}
            		else {
HXLINE( 144)			_hx_tmp1 = false;
            		}
HXDLIN( 144)		if (_hx_tmp1) {
HXLINE( 144)			_hx_tmp = (ms >= (( (Float)(-50) ) * ts));
            		}
            		else {
HXLINE( 144)			_hx_tmp = false;
            		}
HXDLIN( 144)		if (_hx_tmp) {
HXLINE( 145)			rating = HX_("burning",f3,53,ac,9f);
            		}
            		else {
HXLINE( 147)			bool _hx_tmp;
HXDLIN( 147)			bool _hx_tmp1;
HXDLIN( 147)			if ((burning == 2)) {
HXLINE( 147)				_hx_tmp1 = (ms < (( (Float)(50) ) * ts));
            			}
            			else {
HXLINE( 147)				_hx_tmp1 = false;
            			}
HXDLIN( 147)			if (_hx_tmp1) {
HXLINE( 147)				_hx_tmp = (ms >= (( (Float)(-50) ) * ts));
            			}
            			else {
HXLINE( 147)				_hx_tmp = false;
            			}
HXDLIN( 147)			if (_hx_tmp) {
HXLINE( 148)				rating = HX_("ded",c3,39,4c,00);
            			}
            			else {
HXLINE( 150)				if ((burning > 0)) {
HXLINE( 151)					rating = HX_("shit",c0,cf,52,4c);
            				}
            				else {
HXLINE( 155)					bool _hx_tmp;
HXDLIN( 155)					if ((ms <= (( (Float)(166) ) * ts))) {
HXLINE( 155)						_hx_tmp = (ms >= (( (Float)(135) ) * ts));
            					}
            					else {
HXLINE( 155)						_hx_tmp = false;
            					}
HXDLIN( 155)					if (_hx_tmp) {
HXLINE( 156)						rating = HX_("shit",c0,cf,52,4c);
            					}
HXLINE( 157)					bool _hx_tmp1;
HXDLIN( 157)					if ((ms < (( (Float)(135) ) * ts))) {
HXLINE( 157)						_hx_tmp1 = (ms >= (( (Float)(90) ) * ts));
            					}
            					else {
HXLINE( 157)						_hx_tmp1 = false;
            					}
HXDLIN( 157)					if (_hx_tmp1) {
HXLINE( 158)						rating = HX_("bad",c5,b1,4a,00);
            					}
HXLINE( 159)					bool _hx_tmp2;
HXDLIN( 159)					if ((ms < (( (Float)(90) ) * ts))) {
HXLINE( 159)						_hx_tmp2 = (ms >= (( (Float)(45) ) * ts));
            					}
            					else {
HXLINE( 159)						_hx_tmp2 = false;
            					}
HXDLIN( 159)					if (_hx_tmp2) {
HXLINE( 160)						rating = HX_("good",3d,95,69,44);
            					}
HXLINE( 161)					bool _hx_tmp3;
HXDLIN( 161)					if ((ms < (( (Float)(45) ) * ts))) {
HXLINE( 161)						_hx_tmp3 = (ms >= (( (Float)(-45) ) * ts));
            					}
            					else {
HXLINE( 161)						_hx_tmp3 = false;
            					}
HXDLIN( 161)					if (_hx_tmp3) {
HXLINE( 162)						rating = HX_("sick",be,8c,53,4c);
            					}
HXLINE( 163)					bool _hx_tmp4;
HXDLIN( 163)					if ((ms > (( (Float)(-90) ) * ts))) {
HXLINE( 163)						_hx_tmp4 = (ms <= (( (Float)(-45) ) * ts));
            					}
            					else {
HXLINE( 163)						_hx_tmp4 = false;
            					}
HXDLIN( 163)					if (_hx_tmp4) {
HXLINE( 164)						rating = HX_("good",3d,95,69,44);
            					}
HXLINE( 165)					bool _hx_tmp5;
HXDLIN( 165)					if ((ms > (( (Float)(-135) ) * ts))) {
HXLINE( 165)						_hx_tmp5 = (ms <= (( (Float)(-90) ) * ts));
            					}
            					else {
HXLINE( 165)						_hx_tmp5 = false;
            					}
HXDLIN( 165)					if (_hx_tmp5) {
HXLINE( 166)						rating = HX_("bad",c5,b1,4a,00);
            					}
HXLINE( 167)					bool _hx_tmp6;
HXDLIN( 167)					if ((ms > (( (Float)(-166) ) * ts))) {
HXLINE( 167)						_hx_tmp6 = (ms <= (( (Float)(-135) ) * ts));
            					}
            					else {
HXLINE( 167)						_hx_tmp6 = false;
            					}
HXDLIN( 167)					if (_hx_tmp6) {
HXLINE( 168)						rating = HX_("shit",c0,cf,52,4c);
            					}
            				}
            			}
            		}
HXLINE( 171)		return rating;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(Ratings_obj,checkRating,return )

::String Ratings_obj::CalculateRanking(int score,int scoreDef,int nps,int maxNPS,Float accuracy){
            	HX_STACKFRAME(&_hx_pos_c466427e4f3e0023_176_CalculateRanking)
HXLINE( 177)		::String _hx_tmp;
HXDLIN( 177)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )) {
HXLINE( 178)			::String _hx_tmp1;
HXDLIN( 178)			bool _hx_tmp2;
HXDLIN( 178)			if (::PlayStateChangeables_obj::botPlay) {
HXLINE( 178)				_hx_tmp2 = ::PlayState_obj::loadRep;
            			}
            			else {
HXLINE( 178)				_hx_tmp2 = true;
            			}
HXDLIN( 178)			if (_hx_tmp2) {
HXLINE( 178)				_hx_tmp1 = HX_(" | ",44,b4,18,00);
            			}
            			else {
HXLINE( 178)				_hx_tmp1 = HX_("",00,00,00,00);
            			}
HXLINE( 177)			_hx_tmp = (((((HX_("NPS: ",b7,7e,61,1e) + nps) + HX_(" (Max ",24,31,a2,06)) + maxNPS) + HX_(")",29,00,00,00)) + _hx_tmp1);
            		}
            		else {
HXLINE( 177)			_hx_tmp = HX_("",00,00,00,00);
            		}
HXLINE( 179)		::String _hx_tmp1;
HXDLIN( 179)		bool _hx_tmp2;
HXDLIN( 179)		if (::PlayStateChangeables_obj::botPlay) {
HXLINE( 179)			_hx_tmp2 = ::PlayState_obj::loadRep;
            		}
            		else {
...
HXDLIN( 179)			if ((::Conductor_obj::safeFrames != 10)) {
HXLINE( 179)				_hx_tmp = (((score + HX_(" (",08,1c,00,00)) + scoreDef) + HX_(")",29,00,00,00));
            			}
            			else {
HXLINE( 179)				_hx_tmp = (HX_("",00,00,00,00) + score);
            			}
HXLINE( 180)			::String _hx_tmp2;
HXDLIN( 180)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )) {
HXLINE( 181)				::String _hx_tmp = ((HX_(" | Combo Breaks:",10,4a,42,f6) + ::PlayState_obj::misses) + HX_(" | Accuracy:",fd,ee,6b,1b));
HXLINE( 182)				::String _hx_tmp1;
HXDLIN( 182)				bool _hx_tmp3;
HXDLIN( 182)				if (::PlayStateChangeables_obj::botPlay) {
HXLINE( 182)					_hx_tmp3 = !(::PlayState_obj::loadRep);
            				}
            				else {
HXLINE( 182)					_hx_tmp3 = false;
            				}
HXDLIN( 182)				if (_hx_tmp3) {
HXLINE( 182)					_hx_tmp1 = HX_("N/A",00,59,3b,00);
            				}
            				else {
HXLINE( 182)					_hx_tmp1 = (::HelperFunctions_obj::truncateFloat(accuracy,2) + HX_(" %",05,1c,00,00));
            				}
HXLINE( 180)				_hx_tmp2 = (((_hx_tmp + _hx_tmp1) + HX_(" | ",44,b4,18,00)) + ::Ratings_obj::GenerateLetterRank(accuracy));
            			}
            			else {
HXLINE( 180)				_hx_tmp2 = HX_("",00,00,00,00);
            			}
HXLINE( 179)			_hx_tmp1 = ((HX_("Score:",c8,e8,ff,79) + _hx_tmp) + _hx_tmp2);
            		}
            		else {
HXLINE( 179)			_hx_tmp1 = HX_("",00,00,00,00);
            		}
HXLINE( 176)		return (_hx_tmp + _hx_tmp1);
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_99_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",99,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_104_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",104,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_109_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",109,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_114_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",114,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_119_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",119,0x087e5c05)
...
HXLINE(  79)		this->initialState = ::hx::ClassOf< ::Caching >();
...
HXLINE(  84)		this->addChild(this->game);
HXLINE(  87)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  88)		this->addChild(this->fpsCounter);
HXLINE(  89)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_99_toggleFPS)
HXDLIN(  99)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_104_changeFPSColor)
HXDLIN( 104)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_109_setFPSCap)
HXDLIN( 109)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_114_getFPSCap)
HXDLIN( 114)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_119_getFPS)
HXDLIN( 119)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}

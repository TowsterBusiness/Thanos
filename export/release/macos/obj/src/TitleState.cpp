...
HXLINE( 124)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
HXLINE( 196)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_5,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 197)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,15),HX_("",00,00,00,00),24,false,null(),null());
...
HXLINE( 401)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 404)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_19,4));
            			}
            			break;
            			case (int)3: {
...
HXLINE( 417)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,2));
            				}
            				else {
HXLINE( 419)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_21,2));
            				}
            			}
            			break;
            			case (int)7: {

...
HX_DEFINE_STACK_FRAME(_hx_pos_fc55aba1ba34c432_665_new,"BotPlay","new",0x2cacc9ed,"BotPlay.new","Options.hx",665,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_671_press,"BotPlay","press",0x783c8a50,"BotPlay.press","Options.hx",671,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_fc55aba1ba34c432_679_updateDisplay,"BotPlay","updateDisplay",0xe1e3db06,"BotPlay.updateDisplay","Options.hx",679,0x9d9a0240)

void BotPlay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_665_new)
HXLINE( 666)		super::__construct();
HXLINE( 667)		this->description = desc;
            	}
...
bool BotPlay_obj::press(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_671_press)
HXLINE( 672)		::flixel::FlxG_obj::save->data->__SetField(HX_("botplay",7b,fb,a9,61),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 673)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 673)		::String _hx_tmp1 = (HX_("BotPlay : ",2b,ca,ec,4b) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic))));
HXDLIN( 673)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),673,HX_("BotPlay",7b,4f,d4,19),HX_("press",83,53,88,c8)));
HXLINE( 674)		this->display = this->updateDisplay();
HXLINE( 675)		return true;
            	}


::String BotPlay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_fc55aba1ba34c432_679_updateDisplay)
HXDLIN( 679)		::String _hx_tmp;
HXDLIN( 679)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )) {
HXDLIN( 679)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 679)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 679)		return (HX_("BotPlay ",45,3c,f1,7f) + _hx_tmp);
            	}

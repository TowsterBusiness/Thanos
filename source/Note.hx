...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?burning:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inCharter:Bool = false)
	{
		super();
		...
		switch (noteTypeCheck)
		{
			...
			default:
				...
				else if (this.burning == 2) {
					frames = Paths.getSparrowAtlas('NOTE_death');

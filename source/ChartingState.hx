	...
	**/
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var note:Note = new Note(daStrumTime, daNoteInfo, daBurning, null, false, true);
	...
	private function addNote(?n:Note):Void
	{
		...
		if (n != null)
			_song.notes[curSection].sectionNotes.push([n.strumTime, n.noteData, n.sustainLength, n.burning]);
		else
			_song.notes[curSection].sectionNotes.push([noteStrum, noteData, noteSus, noteIsBurning]);
